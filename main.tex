...
The classic first example used to introduce the IFT is the unit circle,
governed by the relation $F(x,y) = x^2 + y^2 - 1 = 0$.
This relation can be interpreted as a system of equations.
...
Next, we have to invert the Jacobian in Eqn.~\ref{eqn:f-jac}:
\begin{equation}
